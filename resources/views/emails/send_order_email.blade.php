                ...
                <table class="bg_white" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td valign="middle" style="text-align:left; padding: 1em 2.5em;">
                            <p><a href="{{ $link1 }}" class="btn btn-primary">Continue your order</a></p>
                        </td>
                    </tr>
                </table>
            </tr><!-- end tr -->
                                ...
                                <table align="center" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td style="font-size:14px; height:20px; color:#ffffff; font-weight:normal; font-family: Open Sans, sans-serif;"
                                            ...
                                            <a href="mailto:support@allstatetostateautotransport.com">support@allstatetostateautotransport
                                                .com</a>
                                        </td>
                                    </tr>
                                    <tr>
