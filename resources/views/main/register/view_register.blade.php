        ...
        <div class="col-12">
            ...
            <div class="card" style="margin-top:0px">
                <div class="card-header">
                    <div class="card-title">All Employees


                    </div>
                    <a type="button" href="{{url('add_employee')}}" style=" margin-left: auto; "
                       class="btn btn-icon btn-primary"><i class="fe fe-plus" ></i>Add
                        Employee</a>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{url('user_deactive'.'/'.$val->id)}}">DeActive</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
