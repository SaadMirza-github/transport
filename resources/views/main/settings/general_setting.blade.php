...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a>No of Days</a></li>
    </ul>

    <!--End Page header-->
    <!-- Row -->
    <form action="/general_setting_save" id="form" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token()}}">
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Add No of Days</div>
                    </div>
                    <div class="card-body">
                        <div class="card-title font-weight-bold"></div>
                        <div class="row">
                            <div class="col-sm-4 col-md-4">
                                <label class="form-label">Enter No of Days</label>
                                <div class="form-inline">
                                    <input type="number" required name="no_of_days" class="form-control"
                                           placeholder="Enter No of Days" value="{{$previous}}">
