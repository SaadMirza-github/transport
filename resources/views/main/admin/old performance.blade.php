    ...
    <div class="card">
        ...
        <div class="card-body">
           <form action="/performance" method="get">
               <label class="radio-inline"><input type="radio" name="ordertaker_dispatcher" value="1" @if($ordertaker_or_dispatcher==1) checked @endif /> &nbsp;Order Taker  </label>
               <label class="radio-inline"> <input type="radio" name="ordertaker_dispatcher" value="2" @if($ordertaker_or_dispatcher==2) checked @endif />&nbsp;Dispatcher</label>
               <input type="month" name="monthv" value="{{$monthyear}}">
...
<?php
function get_order_count($user_id,$monthyear,$ordertaker_or_dispatcher){
            ...
            data: [{
                ...
                dataPoints: [
                      <?php
                        ...
                        ?>
                        { label: "<?php echo $user->name;?>" , y: <?php echo get_order_count($user->id,$monthyear,$ordertaker_or_dispatcher);?> ,color: "lightpink" },
                        <?php
                          }
                        ?>
                    /*
                    { label: "Mehmood", y: 20000 , color: "lightpink" },
                    { label: "Daniyal", y: 27000 , color: "lightgreen" },
                    { label: "Mansoor", y: 8000 , color: "red" },
                    { label: "Noman", y: 17000 , color: "purple" },
                    { label: "Mehdi", y: 32000 , color: "brown" }
                    */
                ]
            }]
        };
