...
<div>
    <div class="card">
        <div class="card-header">
            <div class="card-title">User Rating</div>
        </div>
        <div class="card-body">
            <div class="chartjs-wrapper-demo">
                <div id="chart_rating" class="h-300 mh-300"></div>
            </div>
        </div>
    </div>
</div><!-- col-6 -->
...
<script>
    var options3 = {
        series: [{
            name: 'Total QA Rating',
            data: [
                @foreach($users as $u1)
                {{ get_order_count($u1->id,$monthyear,$ordertaker_or_dispatcher) }},
                @endforeach
            ]
        },
        ],
    ...
    var chart_rating = new ApexCharts(document.querySelector("#chart_rating"), options3);
    chart_rating.render();
