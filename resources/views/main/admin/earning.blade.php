...
@section('content')
    ...
    <div class="row">
        ...
        <div  class="col-sm-12 col-lg-12" ><!-- col-6 -->
            <div class="card">
                <div class="card-header" style=" justify-content: center; ">
                    <h2 style="font-size: 32px;font-family: initial;margin-top: 18px;margin-right: auto;">Earning  </h2><input type="date" class="form-control w-20" name="fromdate" id="fromdate"><span class="form-label" style=" font-size: 21px; padding: 4px; "> to </span> <input type="date" class="form-control w-20" name="todate" id="todate" >
                    <input type="submit" name="show" class="btn btn-info ml-4 w-20" id="show" value="show" onclick="showchart();"/>
                </div>
                <div class="card-body">
                    <div id="chartContainer" class="h-300 mh-300"></div>
                </div>
                <div class="card-footer" style=" text-align: center; ">
                    <h3 style=" font-size: 30px; font-family: initial; margin-top: 18px;color:black ">Total Earning :-  <div id="grandtotal"></div></h3>
                </div>
            </div>
    ...
    <script>
      ...
      function showchart() {
        ...
        var todate=$('#todate').val();
          ...
          $.ajax({
              url: '/get_earning_chart',
              type: 'get',
              data: {fromdate: fromdate,todate: todate},
              success: function(data){
                //  alert(data[4]);
                  $('#grandtotal').html(data[4]);
        ...
        var options = {
            ...
            data: [{
                ...
                labelFontSize: 25,
                dataPoints: [
                    { label: "CALLING", y: + data[0] , color: "lightblue"},
                    { label: "USHIP", y: + data[1] , color: "green" },
                    { label: "HEAVY", y: + data[2] , color: "darkblue" },
                    { label: "DEALER", y: + data[3] , color: "purple" },
                   // { label: "OLD DATA", y: 32000 , color: "yellow" }
                ]
            }]
        };
