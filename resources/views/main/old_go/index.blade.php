        ...
        <!--div-->
            <div class="card">
                <div class="card-header">
                    <form name="typev" method="get" action="/old_go">

                        <button type="submit" class="btn effect01 "  style=" border: inset 1px; color: black; " name="car">Car</button>
                        <button type="submit" class="btn effect01 purple  "  style="width:36%;border:inset 1px;" name="shipment">Shipment</button>
                        <button type="submit" class="btn effect01 darkblue " style=" border: inset 1px;  " name="heavy">Heavy</button>

                        @if(isset($_GET['car']))
                            <input id="p_type" style=" visibility: collapse; " value="car">
                        @elseif(isset($_GET['shipment']))
                            <input id="p_type" style=" visibility: collapse; " value="shipment">
                        @elseif(isset($_GET['heavy']))
                            <input id="p_type" style=" visibility: collapse; " value="heavy">
                        @else
                            <input id="p_type"  style=" visibility: collapse; " value="car">
                        @endif
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data3(page) {
                ...
                var typee = $('#p_type').val();

                $.ajax({

                    url: "/old_go?page=" + page + "&" + typee,
