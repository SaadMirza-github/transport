...
@section('template_title')
    <?php echo $titlee = "EMPLOYEE ORDERS"; ?>
@endsection
...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a>EMPLOYEE ORDERS LIST</a></li>
    </ul>
            ...
            @if(session('flash_message'))
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <span class="form-label w-10">SELECT MONTH</span>
                        <input  class="form-control w-20 m-1" type="month" value="" name="selectmonth" id="selectmonth"/>


                        <select class="form-control w-20 m-1" name="users" id="users"
                                required>
                        ...
                        <select class="form-control w-20 m-1" name="ordertype" id="ordertype"required>
                        ...
                        <button id="sv_btn" style=" width: 11%; margin-left: auto; " type="button" onclick="fetch_data()" class="btn  btn-primary"> DISPLAY</button>
                    </div>
                    <div class="card-body ">

                        <div id="table_data">
                            @include('main.management2.show_employee_order')
                        </div>
                    </div>
                </div>
