...
@section('template_title')
    <?php echo $titlee = "PROFIT LISTING"; ?>
@endsection
            ...
            @if(session('flash_message'))
                ...
                <div class="card">
                    <div class="card-header">
                        <a type="button" href="/all_completed_orders_list"
                           class="btn btn-icon btn-primary"><i class="" ></i>
                            All Completed Orders</a> &nbsp;&nbsp;
                        <a type="button" href="/payment_received_list"
                           class="btn btn-icon btn-primary"><i class="" ></i>
                            Payment Received</a>&nbsp;&nbsp;
                        <a type="button" href="/employee_order"
                           class="btn btn-icon btn-primary"><i class="" ></i>
                            Employee Order</a> &nbsp;&nbsp;
                        <a type="button" href="/all_bookers_list"
                           class="btn btn-icon btn-primary"><i class="" ></i>
                            All Bookers</a>
                    </div>
                    <div class="card-body">
                        <div id="table_data">
                            @include('main.management2.show')
                        </div>
                    </div>
                </div>
