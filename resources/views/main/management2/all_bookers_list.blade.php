            ...
            @if(session('flash_message'))
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="card-title">All Bookers</div>
                        <form action="/all_bookers_list" method="get" style=" display: contents; " >
                    ...
                    <div class="card-body">
                        <div id="table_data">
                            @include('main.management2.show_all_bookers')
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data3(page) {
                ...
                var  url = "/get_all_bookers?page=" + page;
                var monthyear =   $('#monthyear').val();
                if(monthyear.length > 0){

                    url = "/get_all_bookers?page=" + page+"&monthyear="+monthyear;
                }
                $.ajax({
        ...
        function  get_month(){
                ...
                var monthyear =   $('#monthyear').val();
                if(monthyear.length > 0) {
                    url = "/get_all_bookers?monthyear="+ monthyear;
                    $.ajax({
                        url: url,
                        success: function (data) {
                            $('#table_data').html('');
