...
@section('content')
    ...
    <div class="container-fluid register">
        ...
        <form class=" needs-validation" novalidate method="post" onsubmit="return false;" id="calling_form">
            ...
            <input type="hidden" name="orderType" id="orderType" value="{{$data->order_type}}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="register-form">
                                            ...
                                            @foreach($type_array as $value)
                                                @if($counter>0)
                                                    <div id='vehicle_add{{$counter}}'><input type='hidden'
                                                                                             name='count[]'>
                                                        @endif
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 mb-1">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="controls position-relative has-icon-left">
                                                                            <input required type="text" id="vyear{{$counter}}"
                                                                                   name="vyear[]"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4 mb-1">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="controls position-relative has-icon-left">
                                                                            <select name="vehType[]" id="vehType{{$counter}}"
                                                                                    class="form-control this_save"
                        ...
                        <div id='vehicle_add${Ophone_count}'>
                                ...
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'>
                                        ...
                                        <div class='controls position-relative has-icon-left'>
                                                                            <span class='twitter-typeahead'
                                                                                  style=''><input
                                                                                        required type='text' class='form-control tt-hint this_save'
                                                                                        ...
                                                                                        placeholder='Enter Make' class='form-control tt-input vmake0' onkeyup='getmake()'
                                ...
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'>
                                        <h6>
                                            ...
                                            <div class='googleimage pull-right' id='googleimage${Ophone_count}' onclick="googl(${Ophone_count})" >
                                        ...
                                        <div class='controls position-relative has-icon-left'>
                                                                            <span class='twitter-typeahead'
                                                                                  ...
                                                                                  <input
                                                                                          ...
                                                                                          style='position: absolute; top: 0px; left: 0px; border-color: transparent; box-shadow: none; opacity: 1; background: none 0% 0% / auto repeat scroll padding-box padding-box rgb(255, 255, 255);'>
                                                                                        <input
                                                                                                required type='text' name='vmodel[]' id='vmodel${Ophone_count}'  onkeyup="getmodel(${Ophone_count})"
                                                                                                placeholder='Enter Make' class='form-control tt-input vmodel0'
                            ...
                            <div class='row'>
                                ...
                                <div class="col-md-4 mb-1">
                                    ...
                                    <div class="controls position-relative has-icon-left">
                                        <select autocomplete="nope" name="auction[]" class="form-control this_save" id="auction${Ophone_count}" required="" data-validation-required-message="This field is required" aria-invalid="false">
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-4 mb-1 mt-4 ">
                                    ...
                                    <div class="controls position-relative has-icon-left">
                                        <input autocomplete="nope" type="text" name="vcolor[]" id="vcolor${Ophone_count}" class="form-control this_save" value="" placeholder="Enter Vehicle Color" required="" data-validation-required-message="This field is required" aria-invalid="false">
                                        <div class="form-control-position">
                                            <i class="la la-eyedropper"></i>
                                        </div>
                                        <div class="help-block"></div>
