...
@section('content')
    ...
    <div class="container-fluid register">
        ...
        <form class=" needs-validation" novalidate method="post" onsubmit="return false;" id="calling_form">
            @csrf
            <input name="panel_type" type="hidden" value="0">
            ...
            <div class="row">
                ...
                <div class="col-md-3 register-left">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="/calling">Car Quote</a></li>
                    </ul>
                                    ...
                                    <div class="register-form">
                                        ...
                                        <div class="row justify-content-center ">
                                            ...
                                            <a style=" margin-right: 10px;border: 1px solid;"
                                               href="https://www.timeanddate.com/worldclock/usa" target="_blank"
                                            ...
                                            <a style=" margin-right: 10px;border: 1px solid;"
                                               href="https://www.weather.gov/" target="_blank"
                                               class="btn btn-outline-primary">Weather</a>
                                            <a href="http://www.truckmiles.com/FuelPrices.asp" target="_blank"
                                               class="btn btn-blue btn_shade">Fuel Price</a>
                                        </div>
                                        @php
                                            $year=explode('*^', $data->year);
                                            $make=explode('*^', $data->make);
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4 mb-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                        <input required type="text" id="vyear0"
                                                                               name="vyear[]"
                                                                               value="@if(!empty($year[$counter])){{$year[$counter]}}@endif"
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                                <span class="twitter-typeahead"
                                                                                      style=""><input
                                                                                            ...
                                                                                            spellcheck="false"
                                                                                            dir="auto"
                                                                                            value="@if(!empty($make[$counter])){{$make[$counter]}}@endif"
                                                            ...
                                                            <div class="col-lg-4 mb-1">
                                                                <div class="form-group">
                                                                    <h6>
                                                                        ...
                                                                        <div class="googleimage pull-right"
                                                                             id="googleimage{{$counter}}"
                                                                             onclick="googl({{$counter}})">
                                                                            <a href="javascript:void(0);"><img
                                                                                        id="googleImg{{$counter}}"
                                                                                        width="24"
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                                <span class="twitter-typeahead"
                                                                                    ...
                                                                                    <input
                                                                                            required type="text"
                                                                                            value="@if(!empty($model[$counter])){{$model[$counter]}}@endif"
                                                                                            name="vmodel[]"
                                                                                            id="vmodel{{$counter}}"
                                                                                            onkeyup="getmodel({{$counter}})"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                        <select name="vehType[]"
                                                                            ...
                                                                            <option @if(!empty($type[$counter]) && $type[$counter]=='Car') selected
                                                                                    @endif value="Car">Car
                                                                            </option>
                                                                            <option @if(!empty($type[$counter]) && $type[$counter]=='SUV') selected
                                                                                    @endif value="SUV">SUV
                                                                            </option>
                                                                            <option @if(!empty($type[$counter]) && $type[$counter]=='Van') selected
                                                                                    @endif value="Van">Van
                                                                            </option>
                                                                            <option @if(!empty($type[$counter]) && $type[$counter]=='Pickup') selected
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                        <select name="trailer_type[]"
                                                                                id="trailer_type{{$counter}}"
                                                                                class="form-control this_save"
                                                                                required="" autocomplete="nope">
                                                                            <option value="">Select</option>
                                                                            <option @if(!empty($transport[$counter]) && $transport[$counter]=='open') selected
                                                                                    @endif value="open">Open
                                                                            </option>
                                                                            <option @if(!empty($transport[$counter]) && $transport[$counter]=='enclosed') selected
                                                                                    @endif value="enclosed">Enclosed
                                                                            </option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="controls position-relative has-icon-left">
                                                                        <select name="condition[]"
                                                                                ...
                                                                                required="" autocomplete="nope">
                                                                            <option value="">Select</option>
                                                                            <option @if(!empty($condition[$counter]) && $condition[$counter]=='1') selected
                                                                                    @endif value="1">Running
                                                                            </option>
                                                                            <option @if(!empty($condition[$counter]) && $condition[$counter]=='2') selected
                                                                                    @endif value="2">Non-Running
                                                                            </option>
                                                                        </select>
                                                            ...
                                                            <div class="col-md-4 mb-1">
                                                                ...
                                                                <div class="controls position-relative has-icon-left">
                                                                    <select autocomplete="nope" name="auction[]"
                                                                            ...
                                                                            aria-invalid="false">
                                                                        <option value="">Select</option>
                                                                        <option @if(!empty($auction[$counter]) && $auction[$counter]== 1) selected
                                                                                @endif value="1">Yes
                                                                        </option>
                                                                        <option @if(!empty($auction[$counter]) && $auction[$counter]== 2) selected
                                                                                @endif value="2">No
                                                                        </option>
                                                                    </select>
                                                                    <div class="form-control-position">
                                                            ...
                                                            <div class="col-md-4 mb-1">
                                                                ...
                                                                <div class="controls position-relative has-icon-left">
                                                                    <select autocomplete="nope" name="vbrakes[]"
                                                                            ...
                                                                            aria-invalid="false">
                                                                        <option value="">Select</option>
                                                                        <option @if(!empty($brakes[$counter]) && $brakes[$counter]=='1') selected
                                                                                @endif value="1">Working
                                                                        </option>
                                                                        <option @if(!empty($brakes[$counter]) && $brakes[$counter]=='2') selected
                                                                                @endif value="2">Not Working
                                                                        </option>
                                                                    </select>
                                                                    <div class="form-control-position">
                                                                        <i class="la la-car"></i>
                                                            ...
                                                            <div class="col-md-4 mb-1">
                                                                ...
                                                                <div class="controls position-relative has-icon-left">
                                                                    <select autocomplete="nope" name="vrolls[]"
                                                                            ...
                                                                            aria-invalid="false">
                                                                        <option value="">Select</option>
                                                                        <option @if(!empty($rolls[$counter]) && $rolls[$counter]=='1') selected
                                                                                @endif value="1">Working
                                                                        </option>
                                                                        <option @if(!empty($rolls[$counter]) && $rolls[$counter]=='2') selected
                                                                                @endif value="2">Not Working
                                                                        </option>
                                                                    </select>
                                                                    <div class="form-control-position">
                                                            ...
                                                            <div class="col-md-4 mb-1">
                                                                ...
                                                                <div class="controls position-relative has-icon-left">
                                                                    <input autocomplete="nope" type="text"
                                                                           ...
                                                                           id="vcolor{{$counter}}"
                                                                           class="form-control this_save"
                                                                           value="@if(!empty($color[$counter])) {{$color[$counter]}} @endif"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input type="text" name="ophone" id="ophone0"
                                                               class="form-control phone-inputmask ophone this_save"
                                                               value="{{$data->ophone}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mb-1" style="text-align: center;">
                                                @if($data->pstatus !=7 && $data->pstatus != 8 && $data->pstatus !=19)
...
@section('extraScript')
    <script>
        $("#viewCentral").click(function () {
            ...
            var trailter = $("#trailer_type").val();
            var type = $("#vehChkType").val();
            ...
            if (ozip == '' || dzip == '' || vehType == '' || condition == '' || trailter == '') {
                document.getElementById("o_zip").focus();
                document.getElementById("d_zip").focus();
                document.getElementById("condition").focus();
                document.getElementById("trailer_type").focus();
                $("#o_zip").addClass("border_bottom_color");
                $("#d_zip").addClass("border_bottom_color");
                $("#condition").addClass("border_bottom_color");
                $("#trailer_type").addClass("border_bottom_color");
                ...
                var url = `https://version1.autotransportgo.com/save_page?num_vehicles=${numVehicles}&ozip=${ozip[2]}&dzip=${dzip[2]}&enclosed=${trailter}&inop=${condition}&vehicle_types=${veh}&miles=0&${get_ses}`;
            ...
            $("#calling_data").append(`
                <div id='vehicle_add${Ophone_count}'>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-lg-6 text-right'>
                            <a href='javascript:void(0)' onclick='removee(${Ophone_count})' class='this_save'
                               style=' font-size: 39px; '>
                        ...
                        <div class='col-lg-4 mb-1'>
                            <div class='form-group'>
                                ...
                                <div class='controls position-relative has-icon-left'>
                                    <span class='twitter-typeahead'
                                          style=''><input
                                                required type='text' class='form-control tt-hint'
                                                autocomplete='off' readonly='' spellcheck='false'
                                                tabindex='-1' dir='ltr'
                                                style='position: absolute; top: 0px; left: 0px; border-color: transparent; box-shadow: none; opacity: 1; background: none 0% 0% / auto repeat scroll padding-box padding-box rgb(255, 255, 255);'><input
                                                type='text' name='vmake[]' id='vmake${Ophone_count}'
                                                placeholder='Enter Make'
                                                class='form-control tt-input vmake0 this_save' onkeyup='getmake()'
                        ...
                        <div class="col-md-4 mb-1">
                            ...
                            <div class="controls position-relative has-icon-left">
                                <input autocomplete="nope" type="text" name="vcolor[]" id="vcolor${Ophone_count}"
                                       class="form-control this_save"
                                       value="" placeholder="Enter Vehicle Color" required=""
