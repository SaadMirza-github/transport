...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="oterminal" id="oterminal" required="">
                            ...
                            <div class="col-sm-12 buyer_number">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="obuyer_no" id="obuyer_no" class="form-control"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="oemail" id="oemail" class="form-control"
                                           placeholder="Email">
                                </div>
                            </div>
                            <div class="col-sm-12 add_phone">
                                <div class='row'>
                                    ...
                                    <div class="form-group col-11 ">
                                        <input type="text" name="ophone[]" id="ophone" class="form-control ophone"
                                               placeholder="Number">
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="oaddress2" name="oaddress2" class="form-control"
                                           placeholder="Home Address">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Terminal, Dealer, Auction *</label>
                                    <select class="form-control" name="dterminal" id="dterminal" required="">
                            ...
                            <div class="col-sm-12 col-md-12 add_dphone">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-11 ">
                                        <input type="text" name="dphone[]" id="dphone" class="form-control dphone"
                                               placeholder="Number">
                                    </div>
                                    <div class="form-group col-1" style="padding-top: 7px;">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Zip Code</label>
                                    <input type="text" id="d_zip1" class="form-control"
                                ...
                                <div class="form-group">
                                    <label class="rdiobox">
                                        <input name="vehicle${vehicle_count}" id="vehicle${vehicle_count}"
                                               ...
                                               checked value="vehicle" data-parsley-multiple="vehicle${vehicle_count}">
                                ...
                                <div class="form-group">
                                    <label class="rdiobox">
                                        <input name="vehicle${vehicle_count}" id="vin${vehicle_count}" type="radio"
                                               ...
                                               value="vin" data-parsley-multiple="vehicle${vehicle_count}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id='year0' name='vyear[]'
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control makeOpt0" onkeyup="getmake()" id='makeOpt0' name='vmake[]'
                                           placeholder="Enter Make">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">

                                <div class="googleimage" onclick="googl(0)" id="googleimage0"  style="position: absolute; right: 6%;display:none"><a href="javascript:void(0);"><img width="24" src="assets/images/png/google.png"></a></div>

                                <div class="form-group">
                                    <label class="form-label">Model*</label>
                                    <input class="form-control model0" id='model0' onkeyup="getmodel()" name='vmodel[]'
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required="" id="vehType0" onfocus="my_func(0)" name="vehType[]" class="form-control">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required="" id="condition0" name="condition[]" class="form-control">
                                        <option selected="" disabled="">Select</option>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select required="" id="trailter_type0" name="trailter_type[]" class="form-control">
                                        <option selected="" disabled="">Select</option>
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="ckbox">
                                        <input type="checkbox" name="portTitle0[]" id="needTitle0" value="title"><span>&nbsp;Need Title?</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name='addition_info' id='addition_info0' class="form-control"
                            ...
                            <div class="col ">
                                ...
                                <div class="wd-200 mg-b-30">
                                    <div class="input-group">
                                        ...
                                        {{--                                        <input class="form-control" id='pickup_date' name='pickup_date' placeholder="MM/DD/YYYY" type="text" id="pickup_date">--}}
                            ...
                            <div class='row '>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" placeholder="ORDER BOOKING PRICE *" id='orderPrice'
                                    ...
                                    <div class="form-group">
                                        <label class="ckbox">
                                            <input type="checkbox" name="needDeposit" id="needDeposit" value="yes"
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <label class="rdiobox radio_btn">
                                        <input name="central_chk" id="central_chk1" type="radio" value="condirm"
                                    ...
                                    &nbsp;
                                    <label class="rdiobox radio_btn">
                                        <input name="central_chk" id="central_chk2" type="radio" value="may be"
                                               data-parsley-multiple="central_chk">
                                    ...
                                    &nbsp;
                                    <label class="rdiobox radio_btn">
                                        <input name="central_chk" id="central_chk3" type="radio" value="none"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Price to Pay
                                            Carrier</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                            ...
                                            <input class="form-control" autocomplete="nope" type="text"
                                ...
                                <div class="col-lg-6">
                                    <label class="rdiobox radio_btn">
                                        <input name="vehicle" id="carrier_status_1" type="radio" checked="checked"
                                               value="quick_pay"
                                    ...
                                    <label class="rdiobox radio_btn">
                                        <input name="vehicle" id="carrier_status_2" type="radio" value="cod"
                                               data-parsley-multiple="carrier_status">
                                        <span>COD</span>
                                    </label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" autocomplete="nope" style="width: 80%"
                                    ...
                                    <div id="copcodPart" style="display: none">
                                        ...
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">COD/COP Location
                                                <span class="tx-danger">*</span></label>
                                            <select id="cod_cop_loc" name="cod_cop_loc" class="form-control">
                                                <option disabled="" selected=""></option>
                                                <option value="Pickup">Pickup</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label font-weight-bold tx-black">Balance
                                            Amount</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                            ...
                                            <input class="form-control" type="text" name="balance" value="" readonly=""
                                    ...
                                    <div id="balPart" style="display:none">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold tx-black">Balance Payment
                                                Method <span class="tx-danger">*</span></label>
                                            <select id="balance_method" name="balance_method" class="form-control">
                                                <option disabled="" selected=""></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="balance_time" name="balance_time" class="form-control">
                                                <option disabled="" selected=""></option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="additional_2" name="additional_2" rows="8" class="form-control"
    ...
    <div class="modal fade " role="dialog" id="modaldemo8" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo modal_style">
                ...
                <div class="modal-body">
                    ...
                    <div class="row number_yes" style='display:none'>
                        <div class="col-lg-12">
                            <input type="text" class="form-control" maxlength="10" onkeyup="phone_check()"
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-indigo" id="create_new" style="display: none;" type="button">Create New
                    </button>
...
@section('extraScript')
    <script>
            ...
            var data = `<div class="row">
                    ...
                    <div class="col-lg-2 mt-4">
                        <div class="form-group">
                            ...
                            <label class="rdiobox">
                                <input name="pay_cond" id="pay_cond1" type="radio" value="1">
                                <span>COD / COP</span>
                            </label>
                    ...
                    <div class="col-lg-2 mt-4">
                        <div class="form-group">
                            ...
                            <label class="rdiobox">
                                <input name="pay_cond" id="pay_cond2" type="radio" value="2">
                    ...
                    <div class="col-lg-2 mt-4">
                        <div class="form-group">
                            ...
                            <label class="rdiobox">
                                <input name="pay_cond" id="pay_cond3" type="radio" value="3">
                                <span>Pay Now</span>
                            </label>
                    ...
                    <div class="col-lg-2 mt-4">
                        <div class="form-group">
                            ...
                            <label class="rdiobox">
                                <input name="pay_cond" id="pay_cond4" type="radio" value="4">
                                <span>Pay Later</span>
                            </label>
        ...
        function payConditionJS() {
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <label class="rdiobox">
                        <input name="pay_confirm" id="payment_cond1" type="radio" value="1" required>
                        <span>Yes</span>
                    </label>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <label class="rdiobox">
                        <input name="pay_confirm" id="payment_cond2" type="radio" value="0">
                        <span>No</span>
                    </label>
        ...
        `);
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <label class="form-control-label font-weight-bold tx-black">Email Address <span class="tx-danger">*</span></label>
                    <input required class="form-control" autocomplete="nope" type="email" name="oemail2" id="oemail2" value="" >
        ...
        `);
            ...
            $("#pay_cond4").click(function () {
                ...
                //
                //             <label class="form-control-label font-weight-bold tx-black">Email Address <span class="tx-danger">*</span></label>
                //             <input required class="form-control" autocomplete="nope" type="text" id="oemail2" value="" >
                //
                //         </div>
                //     </div>
                // `);
        ...
        `);
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <label class="rdiobox">
                        <input name="confirm" onchange="sendConf(1)" type="radio" value="1" required>
                        <span>Yes</span>
                    </label>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    ...
                    <label class="rdiobox">
                        <input name="confirm" onchange="sendConf(2)" type="radio" value="0">
                        <span>No</span>
                    </label>
        ...
        `);
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <label class="form-control-label font-weight-bold tx-black" id="emailAddrTxt">Email Address <span class="tx-danger">*</span></label>
                    <input required class="form-control" autocomplete="nope" type="text" name="oemail2" id="oemail2" value="" >
        ...
        $("#needDeposit").click(function () {
            if ($(this).is(":checked")) {
                $("#depositContent").html(`
                <label class="form-control-label font-weight-bold tx-black">Deposit Amount <span class="tx-danger">*</span></label>
                <div class="input-group">
                    <div class="input-group-prepend">
                                                <div class="input-group-text">
                    ...
                    <input class="form-control" autocomplete="nope" type="text" required
        ...
        $("#pickup_date").change(function () {
            ...
            if (pickupDate) {
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="rdiobox">
                            <input name="when_pickup" id="pickup1" type="radio" value="before">
                            <span>Before</span>
                        </label>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="rdiobox">
                            <input name="when_pickup" id="pickup2" type="radio" value="after">
                            <span>After</span>
                        </label>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="rdiobox">
                            <input name="when_pickup" id="pickup3" type="radio" value="on">
                            <span>On</span>
                        </label>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="rdiobox">
                            <input name="when_pickup" id="pickup4" type="radio" value="asap">
                            <span>ASAP</span>
                        </label>
                    </div>
                </div>
            ...
            if (pickupDate) {
                ...
                $("#whenDeliveryDate").html(`<div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="rdiobox">
                                            <input name="when_delivery" id="delivery1" type="radio" value="before">
                                            <span>Before</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="rdiobox">
                                            <input name="when_delivery" id="delivery2" type="radio" value="after">
                                            <span>After</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="rdiobox">
                                            <input name="when_delivery" id="delivery3" type="radio" value="on">
                                            <span>On</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="rdiobox">
                                            <input name="when_delivery" id="delivery4" type="radio" value="asap">
                                            <span>ASAP</span>
                                        </label>
                                    </div>
                                </div>
            ...
            if (id == 1 || id == 8 || id == 9 || id == 10) {
                ...
                if (id == 7 || id == 6) {
                    $(".dauc").html(`
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label id="dauction" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control" autocomplete="nope" type="text" name="dauction" id="dacution_name" value="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label id="dauctionpho" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control ophone" autocomplete="nope" type="text" name="dauctionpho" id="dacutionphoNo" value="">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label font-weight-bold tx-black">Terminal</label>
                            <input class="form-control" autocomplete="nope" type="text" name="port_terminal" id="port_terminal" value="">
                        </div>
                    </div>
                `);
                } else {
                    $(".dauc").html(`
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label id="dauction" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control" autocomplete="nope" type="text" name="dauction" id="dacution_name" value="" required>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label id="dauctionpho" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control ophone" autocomplete="nope" type="text" name="dauctionpho" id="dacutionphoNo" value="" required>
                        </div>
                    </div>
                `);
                }
        ...
        $("#oterminal").change(function () {
            ...
            if (id == 1) {
                ...
                $(".oauc").html(`
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label id="oacution" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control" autocomplete="nope" class="form-control" type="text" name="oacution" id="oacution_name" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label id="oacutionpho" class="form-control-label font-weight-bold tx-black"></label>
                            <input class="form-control ophone" autocomplete="nope" type="text" class="form-control" name="oacutionpho" id="oacutionphoNo" value="">
                        </div>
                    </div>
                     <div class="col-sm-12">
                            <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(`.add_vehicle_btn`).click(function () {
            $(`.add_vehicle_information`).append(`<div class="vehicle_add"> <div class="row "> <div class="col-5"> <div class="form-group"> <label class="rdiobox"> <input name="vehicle${vehicle_count}" id="vehicle${vehicle_count}" onclick="vehicle_append(${vehicle_count})" type="radio" checked="" value="vehicle" data-parsley-multiple="vehicle${vehicle_count}"> <span>Year, Make, and Model</span> </label> </div> </div> <div class="col-5 "> <div class="form-group"> <label class="rdiobox"> <input name="vehicle${vehicle_count}" id="vin${vehicle_count}" onclick="vin_append(${vehicle_count})" type="radio" value="vin" data-parsley-multiple="vehicle${vehicle_count}"> <span>Vin Number</span> </label> </div> </div> <div class="col-2 btn-list"> <button style="margin-left: 19%;" type="button" class="btn btn-danger btn_remove"> <i class="mr-2" id="add-more" onclick="vehicleUpdate(1)"></i>Remove</button> </div> </div> <div class="row"> <div class="col-sm-12 col-md-12 vin_toggle${vehicle_count}"> </div><div class="col-sm-6 col-md-6"> <div class="form-group"> <label class="form-label">Year*</label> <input type="text" class="form-control" id="year${vehicle_count}" name="vyear[]" placeholder="Enter Year"> </div></div><div class="col-sm-6 col-md-6"><div class="form-group"> <label class="form-label">Make*</label> <input type="email" class="form-control makeOpt0" id="makeOpt${vehicle_count}" onkeyup="getmake()" name="vmake[]" placeholder="Enter Make"></div> </div><div class="col-sm-6 col-md-6"><div class="googleimage" onclick="googl(${vehicle_count})" id="googleimage${vehicle_count}"  style="position: absolute; right: 6%;display:none"><a href="javascript:void(0);"><img width="24" src="assets/images/png/google.png"></a></div><div class="form-group"> <label class="form-label">Model*</label> <input type="text" id="model${vehicle_count}"  onkeyup="getmodel()" name="vmodel[]"  class="form-control model0" placeholder="Enter Model"></div></div> <div class="col-sm-6 col-md-6"><div class="form-group"> <label class="form-label">Vehicle Type*</label> <select required="" id="vehType${vehicle_count}"  onfocus="my_func(${vehicle_count})" name="vehType[]" class="form-control"> <option selected="" value="">Select Type</option> <option value="Car">Car</option> <option disabled="">————————————</option> <option value="motorcycle">Motorcycle</option> <option value="3_wheel_sidecar">3 Wheel Sidecar</option> <option value="3_wheel_motorcycle">3 Wheel Motorcycle</option> <option value="atv">ATV</option> <option disabled="">————————————</option> <option value="SUV">SUV</option> <option value="Mid SUV">Mid SUV</option> <option value="Large SUV">Large SUV</option> <option disabled="">————————————</option> <option value="Van">Van</option> <option value="Mini Van">Mini Van</option> <option value="Cargo Van">Cargo Van</option> <option value="Passenger Van">Passenger Van</option> <option disabled="">————————————</option> <option value="Pickup">Pickup</option> <option value="Pickup Dually">Pickup Dually</option> <option value="Box Truck Dually">Box Truck Dually</option> <option disabled="">————————————</option> <option value="other_vehicle">Other Vehicle</option> <option value="other_motorcycle">Other Motorcycle</option> </select> </div> </div><div class="col-sm-6 col-md-6"> <div class="form-group"> <label class="form-label">Vehicle Condition *</label> <select required="" id="condition0" name="condition[]" class="form-control"> <option selected="" disabled="">Select</option> <option value="operable">Running</option> <option value="non-running">Not Running</option> </select> </div> </div> <div class="col-sm-6 col-md-6"> <div class="form-group"> <label class="form-label">Trailer Type *</label> <select required="" id="trailter_type0" name="trailter_type[]" class="form-control"> <option selected="" disabled="">Select</option> <option value="open">Open</option> <option value="enclosed">Enclosed</option> </select> </div> </div> <div class="col-sm-6 col-md-6"> &nbsp; <div class="form-group"> <label class="ckbox"> <input type="checkbox" name="portTitle0[]" id="needTitle0" value="title"><span>&nbsp;Need Title?</span> </label> </div> </div>  </div> </div>  </div></div> &nbsp;`);
            vehicle_count++;
        });
        ...
        $("#central_chk1").click(function () {
            ...
            $("#confirm_book").html(`
                <div class="col-lg-6">
                    <input class="form-control" autocomplete="nope" type="text" name="company_name" id="company_name" placeholder="Company Name">
                    </div> <div class="col-lg-6">
                    <input class="form-control" autocomplete="nope" type="text" name="company_price" id="company_price" placeholder="Price">
                </div> `);
        });
        ...
        $("#central_chk2").click(function () {
            ...
            $("#may_be_book").html(`
                    <div class="col-lg-4" style="padding-left: 15px;padding-right: 0px;">
                        <input class="form-control" autocomplete="nope" type="text" name="company_name" id="company_name2" placeholder="Company Name">
                        </div> <div class="col-lg-2" style="padding-left: 5px;padding-right: 0px;">
                        <input class="form-control" autocomplete="nope" type="text" name="company_price" id="company_price2" placeholder="Price">
                        </div> <div class="col-lg-6" style="padding-left: 5px;">
                        <input class="form-control" autocomplete="nope" type="text" name="company_comments" id="company_comments" placeholder="Comments">
                    </div> `);
        });
        ...
        function vin_append(vehicle_count) {
            ...
            $(`.vin_toggle${vehicle_count}`).html(`
                                        ...
                                        <div class="input-group vin_show${vehicle_count}" style="padding-bottom: 12px;padding-top: 19px;">
                                            ...
                                            <input required="" class="form-control" type="text" onkeyup="get_vin(${vehicle_count})" name="vin_num[]" id="vinNum${vehicle_count}" value=""
