...
@section('content')
    ...
    <div class="container-fluid register">
        ...
        <form class=" needs-validation" novalidate method="post" onsubmit="return false;" id="calling_form">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                                                <span class="twitter-typeahead"
                                                                                    ...
                                                                                    <input
                                                                                            required type="text"
                                                                                            name="vmodel[]" id="vmodel0"
                                                                                            onkeyup="getmodel(0)"
                                                                                            placeholder="Enter Make"
                                                                                            class="form-control
                                                                                            tt-input vmodel0 this_save"
                                                                                            autocomplete="off"
                                                                                            spellcheck="false"
                                                                                            dir="auto"
                                                                                            style="position: relative; vertical-align: top; background-color: transparent;"><pre
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="vehType[]" id="vehType" class="form-control this_save"
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="trailer_type[]" id="trailer_type"
                                                                    class="form-control this_save"
                                                                    required="" autocomplete="nope">
                                                                <option value="">Select</option>
            ...
            <input type="hidden" class="this_save" name="customer_or_dealer" id="customer_or_dealer" value="">
...
//            $('#getPriceNow ').show();
        ...
        $("#siteOk").click(function () {
            ...
            var customer_or_dealare=$('input[name=type]:checked').val();

            $("#customer_or_dealer").val(customer_or_dealare);
    ...
    <div class='row'>
        ...
        <div class='col-lg-6 text-right'>
            <a href='javascript:void(0)' onclick='removee(${Ophone_count})' class='' style=' font-size: 39px; '>
