                                ...
                                <div class="col-md-12">
                                    <div class="register-form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" id="year_make_model0"
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="vehType[]" id="equipment0"
                                                                    class="form-control this_save" required="" autocomplete="nope"
                                                                    aria-invalid="false">
                                                                <option value="">Select</option>
                                                                <option value="utility">Utility</option>
                                                                <option value="trucks">Trucks</option>
                                                                <option value="light_construction">Light Construction
                                                                </option>
                                                                ...
                                                                <option value="asphalt/concrete">Asphalt/Concrete
                                                                </option>
                                                                <option value="compactors">Compactors</option>
                                                                <option value="attachments">Attachments</option>
                                                                <option value="drills">Drills</option>
                                                                <option value="heavy_construction">Heavy Construction
                                                                </option>
                                                                <option value="railroad">Railroad</option>
                                                                <option value="industrial_plant">Industrial Plant
                                                                </option>
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="service[]" id="service0" class="form-control this_save"
                                                                ...
                                                                <option value="step_deck_trailer">Step Deck Trailer
                                                                </option>
                                                                <option value="removable_gooseneck_trailer">Removable
                                                                    Gooseneck Trailer (RNG)
                                                                </option>
                                                                <option value="extendable_flatbed_trailer">Extendable
                                                                    Flatbed Trailer
                                                                </option>
                                                                <option value="stretch_single_drop_deck_trailer">Stretch
                                                                    Single Drop Deck Trailer
                                                                </option>
                                                                <option value="tow_away">Tow Away</option>
                                                                <option value="drive_away">Drive Away</option>
                                                                <option value="2_3_car_hauler">2 or 3 Car Hauler
                                                                </option>
                                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="price[]" id="price0"
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left this_save">
                                            ...
                                            <div class="row after-add-more">
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="lengthft[]" id="lengthft0"
                                                                   class="form-control this_save" value="" placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="lengthin[]" id="lengthin0"
                                                                   class="form-control this_save" value="" placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="widthft[]" id="widthft0"
                                                                   class="form-control this_save" value="" placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="widthin[]" id="widthin0"
                                                                   class="form-control this_save" value="" placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                            ...
                                            <div class="row after-add-more">
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="heightft[]" id="heightft0"
                                                                   class="form-control this_save" value="" placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="heightin[]" id="heightin0"
                                                                class="form-control this_save" value="" placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                ...
                                                <div class="col-lg-6 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="weight[]" id="weight0"
                                                                   class="form-control this_save" value="" placeholder="lbs" data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12" id="payCondition" style=" margin-left: 19%; "></div>
    ...
    <script>
        ...
        $("input[name=changeprice]:radio").click(function () {
            if ($('input[name=changeprice]:checked').val() == "1") {
                ...
                $("#price_1").attr("contenteditable", false);
                $('#cust_email ').show();
