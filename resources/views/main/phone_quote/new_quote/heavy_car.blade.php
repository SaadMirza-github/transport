...
@section('content')
    ...
    <div class="container-fluid register">
                            ...
                            <div class="register-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-1" style="text-align: center;">
                                        <input type="submit" id="getPriceNow"  value="getPriceNow"/>
        ...
        <div class="modal animated zoomInUp text-left show" id="backdrop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" style="display: block;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel4">
                            <strong>Order On Phone</strong>
                        </h3>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-center mt-1">
                            <div class="col-lg-6 col">
                                <select name="site" id="site" class="form-control" required="">
                                    ...
                                    <option value="8">autotransportmy</option>
                                    <option value="9">autoshippingmy</option>
                                    <option value="14">autoshippingamerica</option>
                                    <option value="15">autotransporta1</option>
                                    <option value="27">unitedstatesautotransport</option>
                                    <option value="112">allstatetostateautotransport</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center mt-1">
                            <div class="col-lg-6">
                                <a href="javascript:void(0)" class="btn btn-block btn-primary" id="siteOk">Ok</a>
                            </div>
                        </div>
