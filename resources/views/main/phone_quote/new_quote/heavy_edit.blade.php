...
@section('content')
    ...
    <style>
        ...
        .gradient-border:after {
            ...
            background: linear-gradient(50deg,#ff0000,#6284FF,#FF0000,#6284FF);
    ...
    <div class="container-fluid register">
        ...
        <form class=" needs-validation" novalidate method="post" onsubmit="return false;" id="calling_form">
            @csrf
            <input name="panel_type" type="hidden" value="2">
            ...
            <div class="row">
                ...
                <div class="col-md-3 register-left">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="//heavy">Heavy Quote</a></li>
                    </ul>
                    <img src="{{ url('/public/assets/images/pictures/truck_image.png')}}" alt="truck_image.png"/>

                    <h3>Order On Phone</h3>

                    <p>Create Heavy Quote Here!</p>
                                ...
                                <div class="col-md-12">
                                    <div class="register-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group validate">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input required type="text" name="o_zip" id="o_zip"
                                                               ...
                                                               value="{{$data->originzsc}}" placeholder="Enter Zip"
                                                ...
                                                <div class="form-group">
                                                    <div class="controls position-relative has-icon-left">
                                                        <select required name="ostate" id="ostate" class="form-control this_save"
                                                                data-validation-required-message="This field is required"
                                                                autocomplete="nope" aria-invalid="false">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls position-relative has-icon-left">
                                                        <input required type="text" name="ocity" id="ocity"
                                                               class="form-control this_save"
                                                               value="{{$data->origincity}}" placeholder="Enter City"
                                                               data-validation-required-message="This field is required"
                                                               autocomplete="nope">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input required type="text" name="d_zip" id="d_zip"
                                                               class="form-control this_save"
                                                               value="{{$data->destinationzsc}}" placeholder="Enter Zip"
                                                               data-validation-required-message="This field is required"
                                                               autocomplete="nope" aria-invalid="false">
                                                ...
                                                <div class="form-group">
                                                    <div class="controls position-relative has-icon-left">
                                                        <select required name="dstate" id="dstate" class="form-control this_save"
                                                                data-validation-required-message="This field is required"
                                                                autocomplete="nope" aria-invalid="false">
                                                            <option value="">Select State</option>
                                                            <option value="AL">Alabama</option>
                                                ...
                                                <div class="form-group">
                                                    <div class="controls position-relative has-icon-left">
                                                        <input required type="text" name="dcity" id="dcity"
                                                               class="form-control this_save"
                                                               value="{{$data->destinationcity}}" placeholder="Enter City"
                                                               data-validation-required-message="This field is required"
                                                               autocomplete="nope">
                                        ...
                                        <div class="row justify-content-center ">
                                            ...
                                            <a style=" margin-right: 10px; " href="javascript:void(0)" id="viewCentral"
                                        ...
                                        <div class="row ">
                                            {{--<div class="col-lg-12 mt-4">--}}
                                                {{--<div class="form-group">--}}
                                                    ...
                                                    {{--<div class="controls position-relative has-icon-left">--}}
                                                        {{--<input type="text" name="mileage" readonly="" id="mileage"--}}
                                                               {{--class="form-control" value="" placeholder="Mileage"--}}
                                                               {{--required="" autocomplete="nope" aria-invalid="false">--}}
                                        ...
                                        @php
                                        $ymk=explode('*^', $data->ymk);
                                        $type=explode('*^', $data->type);
                                        $servicetype=explode('*^', $data->service_type);
                                        $price=explode('*^', $data->price);
                                        $transport=explode('*^', $data->transport);
                                        $condition=explode('*^', $data->condition);
                                        $lengthft=explode('*^', $data->length_ft);
                                        $lengthin=explode('*^', $data->length_in);
                                        $widthft=explode('*^', $data->width_ft);
                                        $widthin=explode('*^', $data->width_in);
                                        $heightft=explode('*^', $data->height_ft);
                                        $heightin=explode('*^', $data->height_in);
                                        $weight=explode('*^', $data->weight);
                                        $auction=explode('*^', $data->is_auction);
                                        $brakes=explode('*^', $data->brakes);
                                        $rolls=explode('*^', $data->rolls);
                                        $color=explode('*^', $data->color);
                                        $avdate=explode('*^', $data->available_date);
                                     ...
                                     @foreach($type_array as $value)
                                      @if($counter>0)
                                       <div id='vehicle_add{{$counter}}'><input type='hidden' name='count[]'>
                                      @endif
                                        <div id="carEquip">
                                            ...
                                            @if($counter==0)
                                                <div class="col-lg-6 text-right">
                                                    <a href="javascript:void(0)" id="addMore" class=""
                                            ...
                                            @if($counter>0)
                                                <div class='col-lg-6 text-right'>
                                                    <a href='javascript:void(0)' onclick='removee({{$counter}})' class='' style=' font-size: 39px; '>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" id="year_make_model{{$counter}}"
                                                                   value="@if(!empty($ymk[$counter])){{$ymk[$counter]}}@endif"
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="vehType[]" id="equipment{{$counter}}"
                                                                    class="form-control this_save" required="" autocomplete="nope"
                                                                    aria-invalid="false">
                                                                <option value="">Select</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='utility') selected @endif value="utility">Utility</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='trucks') selected @endif value="trucks">Trucks</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='light_construction') selected @endif value="light_construction">Light Construction
                                                                </option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='tractors') selected @endif value="tractors">Tractors</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='lifts') selected @endif value="lifts">Lifts</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='excavators') selected @endif value="excavators">Excavators</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='agricultural') selected @endif value="agricultural">Agricultural</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='trailers') selected @endif value="trailers">Trailers</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='cranes') selected @endif value="cranes">Cranes</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='asphalt/concrete') selected @endif value="asphalt/concrete">Asphalt/Concrete
                                                                </option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='compactors') selected @endif value="compactors">Compactors</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='attachments') selected @endif value="attachments">Attachments</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='drills') selected @endif value="drills">Drills</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='heavy_construction') selected @endif value="heavy_construction">Heavy Construction
                                                                </option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='railroad') selected @endif value="railroad">Railroad</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='industrial_plant') selected @endif value="industrial_plant">Industrial Plant
                                                                </option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='environmental') selected @endif value="environmental">Environmental</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='rv') selected @endif value="rv">RV’s</option>
                                                                <option @if(!empty($type[$counter]) && $type[$counter]=='motorhome') selected @endif value="motorhome">Motorhome</option>
                                                            </select>
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="service[]" id="service{{$counter}}" class="form-control this_save"
                                                                    required="" autocomplete="nope"
                                                                    aria-invalid="false">
                                                                <option value="">Select</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='none') selected @endif value="none">None</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='flatbed_trailer') selected @endif value="flatbed_trailer">Flatbed Trailer</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='lowboy_trailer') selected @endif value="lowboy_trailer">Lowboy Trailer</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='step_deck_trailer') selected @endif value="step_deck_trailer">Step Deck Trailer
                                                                </option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='removable_gooseneck_trailer') selected @endif value="removable_gooseneck_trailer">Removable
                                                                    Gooseneck Trailer (RNG)
                                                                </option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='extendable_flatbed_trailer') selected @endif value="extendable_flatbed_trailer">Extendable
                                                                    Flatbed Trailer
                                                                </option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='stretch_single_drop_deck_trailer') selected @endif value="stretch_single_drop_deck_trailer">Stretch
                                                                    Single Drop Deck Trailer
                                                                </option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='tow_away') selected @endif value="tow_away">Tow Away</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='drive_away') selected @endif value="drive_away">Drive Away</option>
                                                                <option @if(!empty($servicetype[$counter]) && $servicetype[$counter]=='2_3_car_hauler') selected @endif value="2_3_car_hauler">2 or 3 Car Hauler
                                                                </option>
                                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="price[]" id="prices{{$counter}}"
                                                                   class="form-control this_save"
                                                                   value="{{$price[$counter]}}"
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="trailer_type[]" id="trailer_type{{$counter}}"
                                                                    class="form-control this_save"
                                                                    required="" autocomplete="nope">
                                                                <option value="">Select</option>
                                                                <option @if(!empty($transport[$counter]) && $transport[$counter]=='open') selected @endif value="open">Open</option>
                                                                <option @if(!empty($transport[$counter]) && $transport[$counter]=='enclosed') selected @endif value="enclosed">Enclosed</option>
                                                ...
                                                <div class="col-lg-4 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <select name="condition[]" id="condition{{$counter}}"
                                                                    class="form-control this_save"
                                                                    required="" autocomplete="nope">
                                                                <option value="">Select</option>
                                                                <option @if(!empty($condition[$counter]) && $condition[$counter]=='1') selected @endif value="1">Running</option>
                                                                <option @if(!empty($condition[$counter]) && $condition[$counter]=='2') selected @endif value="2">Non-Running</option>
                                                            </select>
                                            ...
                                            <div class="row after-add-more">
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="lengthft[]"
                                                                   id="lengthft{{$counter}}" class="form-control this_save" value="@if(!empty($lengthft[$counter])){{$lengthft[$counter]}}@endif"
                                                                   placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="lengthin[]" id="lengthin{{$counter}}"
                                                                   class="form-control this_save" value="@if(!empty($lengthin[$counter])){{$lengthin[$counter]}}@endif" placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="widthft[]" id="widthft{{$counter}}"
                                                                   class="form-control this_save" value="@if(!empty($widthft[$counter])){{$widthft[$counter]}}@endif"
                                                                   placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="widthin[]" id="widthin{{$counter}}"
                                                                   class="form-control this_save" value="@if(!empty($widthin[$counter])){{$widthin[$counter]}}@endif"
                                                                   placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row after-add-more">
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="heightft[]"
                                                                   id="heightft{{$counter}}" class="form-control this_save"
                                                                   value="@if(!empty($heightft[$counter])){{$heightft[$counter]}}@endif" placeholder="ft." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-3 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="heightin[]" id="heightin{{$counter}}"
                                                                   class="form-control this_save" value="@if(!empty($heightin[$counter])){{$heightin[$counter]}}@endif"
                                                                   placeholder="in." data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                ...
                                                <div class="col-lg-6 mb-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls position-relative has-icon-left">
                                                            <input required type="text" name="weight[]" id="weight{{$counter}}"
                                                                   class="form-control this_save" value="@if(!empty($weight[$counter])){{$weight[$counter]}}@endif" placeholder="lbs" data-validation-required-message="This field is required" autocomplete="nope">
                                                            <div class="form-control-position">
                                                                <i class="la la-truck"></i>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-1">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <select autocomplete="nope" name="auction[]" class="form-control this_save"
                                                                id="auction{{$counter}}" required=""
                                                                data-validation-required-message="This field is required"
                                                                aria-invalid="false">
                                                            <option value="">Select</option>
                                                            <option @if(!empty($auction[$counter]) && $auction[$counter]=='1') selected @endif value="1">Yes</option>
                                                            <option @if(!empty($auction[$counter]) && $auction[$counter]=='2') selected @endif value="2">No</option>
                                                        </select>
                                                        <div class="form-control-position">
                                                ...
                                                <div class="col-md-4 mb-1">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <select autocomplete="nope" name="vbrakes[]" class="form-control this_save"
                                                                id="vbrakes{{$counter}}" required=""
                                                                data-validation-required-message="This field is required"
                                                                aria-invalid="false">
                                                            <option value="">Select</option>
                                                            <option @if(!empty($brakes[$counter]) && $brakes[$counter]=='1') selected @endif value="1">Working</option>
                                                            <option @if(!empty($brakes[$counter]) && $brakes[$counter]=='2') selected @endif value="2">Not Working</option>
                                                        </select>
                                                        <div class="form-control-position">
                                                            <i class="la la-car"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-4 mb-1">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <select autocomplete="nope" name="vrolls[]" class="form-control this_save"
                                                                id="vrolls{{$counter}}" required=""
                                                                data-validation-required-message="This field is required"
                                                                aria-invalid="false">
                                                            <option value="">Select</option>
                                                            <option @if(!empty($rolls[$counter]) && $rolls[$counter]=='1') selected @endif value="1">Working</option>
                                                            <option @if(!empty($rolls[$counter]) && $rolls[$counter]=='2') selected @endif value="2">Not Working</option>
                                                        </select>
                                                        <div class="form-control-position">
                                                            <i class="la la-car"></i>
                                                        </div>
                                                ...
                                                <div class="col-md-4 mb-1">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input autocomplete="nope" type="text" name="vcolor[]"
                                                               id="vcolor{{$counter}}"
                                                               class="form-control this_save" value="@if(!empty($color[$counter])) {{$color[$counter]}} @endif"
                                      ...
                                      @endif
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input required type="text" name="oname" id="oname0"
                                                               class="form-control this_save"
                                                               value="{{$data->oname}}" placeholder="Enter Name"
                                                               autocomplete="nope">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                        <input type="text" name="ophone" id="ophone0"
                                                               class="form-control phone-inputmask ophone this_save" value="{{$data->ophone}}"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls position-relative has-icon-left">
                                                                            <textarea type="text" name="additionalinfo"
                                                                                      ...
                                                                                      autocomplete="nope">{{$data->additional_info}}</textarea>
                                            ...
                                            <div class="col-lg-12 mb-1" style="text-align: center;">
                                                @if($data->pstatus<>8 && $data->pstatus<>19)
                                                <input type="submit" id="getPriceNow" class="btn btn-info btn_shade"
                                                       value="Get Price Now"/>
                                                @endif
                                            </div>
                                           @if($data->pstatus<=7)
                                            ...
                                            <div class="col-lg-12" id="payCondition" style=" margin-left: 19%; ">
...
@section('extraScript')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#o_zip').trigger('change');
            $('#d_zip').trigger('change');
...
//            $('#getPriceNow ').show();
    ...
    <script>
        ...
        var Ophone_count = '<?php echo $counter;?>';
        ...
        $("#addMore").click(function () {
            $("#calling_data").append(`
                    <div id='vehicle_add${Ophone_count}'><input type='hidden' name='count[]'>
                        <div id='carEquip'><input required='' type='hidden' name='count[]'>
                            <div class='row '>
                                <div class='col-lg-6' style=' padding-top: 2%; '>
                                    <h6 class='font-weight-bold'>
                                        HEAVY EQUIPMENT
                                ...
                                <div class='col-lg-6 text-right'>
                                    <a href='javascript:void(0)' onclick='removee(${Ophone_count})' class='this_save' style=' font-size: 39px; '>
                                        <i class='fa fa-minus-circle' aria-hidden='true'></i>
                                    </a>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'>
                                        ...
                                        <div class='controls position-relative has-icon-left'><input required='' type='text'
                                                                                                     id='year_make_model${Ophone_count}'
                                                                                                     name='year_make_model[]'
                                                                                                     placeholder='Enter Year, Make &amp; Model'
                                                                                                     class='form-control this_save'
                                                                                                     data-validation-required-message='This field is required'
                                                                                                     autocomplete='nope'>
                                            <div class='form-control-position'><i class='la la-truck'></i></div>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'><h6><strong> Equipment Type <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong></h6>
                                        <div class='controls position-relative has-icon-left'>
                                            <select name='vehType[]' id='equipment${Ophone_count}'
                                                    class='form-control this_save' required=''
                                                    autocomplete='nope'
                                                    aria-invalid='false'>
                                                ...
                                                <option value='light_construction'>Light Construction</option>
                                ...
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'><h6><strong> Service Type <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong></h6>
                                        <div class='controls position-relative has-icon-left'>
                                            <select name='service[]'
                                                    id='service${Ophone_count}'
                                                    class='form-control this_save' required=''
                                                    autocomplete='nope'
                                                    aria-invalid='false'>
                                                <option value=''>Select</option>
                                                ...
                                                <option value='lowboy_trailer'>Lowboy Trailer</option>
                                                <option value='step_deck_trailer'>Step Deck Trailer</option>
                                                <option value='removable_gooseneck_trailer'>Removable Gooseneck Trailer (RNG)</option>
                                                <option value='extendable_flatbed_trailer'>Extendable Flatbed Trailer</option>
                                                <option value='stretch_single_drop_deck_trailer'>Stretch Single Drop Deck Trailer</option>
                                                <option value='tow_away'>Tow Away</option>
                                                <option value='drive_away'>Drive Away</option>
                                                <option value='2_3_car_hauler'>2 or 3 Car Hauler</option>
                                            </select>
                                            <div class='form-control-position'><i class='la la-truck'></i></div>
                                        </div>
                                    </div>
                            ...
                            <div class='row'>
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'><h6><strong> Price <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong></h6>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='price[]'
                                                   id='prices${Ophone_count}'
                                ...
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'>
                                        <h6>
                                            <strong> Carrier Type <span class='text-danger'><span
                                                            class='required'>*</span></span>
                                            </strong>
                                        </h6>
                                        <div class='controls position-relative has-icon-left'>
                                            <select name='trailer_type[]'
                                                    id='trailer_type${Ophone_count}'
                                                    class='form-control this_save' required=''
                                                    autocomplete='nope'>
                                                <option value=''>Select</option>
                                ...
                                <div class='col-lg-4 mb-1'>
                                    <div class='form-group'>
                                        <h6>
                                            <strong> Condition <span class='text-danger'><span class='required'>*</span></span>
                                            </strong>
                                        </h6>
                                        <div class='controls position-relative has-icon-left'>
                                            <select name='condition[]'
                                                    id='condition${Ophone_count}'
                                                    class='form-control this_save' required=''
                                                    autocomplete='nope'>
                                                <option value=''>Select</option>
                                            ...
                                            <div class='form-control-position'><i class='la la-check-square-o'></i></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class='row after-add-more'>
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'>
                                        <h5><strong> Length <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong>
                                        </h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='lengthft[]'
                                                   id='lengthft${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='ft.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                                ...
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'><h5 style='margin-top: 27px'></h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='lengthin[]'
                                                   id='lengthin${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='in.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                                ...
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'>
                                        <h5><strong> Width <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong>
                                        </h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='widthft[]'
                                                   id='widthft${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='ft.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                                ...
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'><h5 style='margin-top: 27px'></h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input type='text' name='widthin[]'
                                                   id='widthin${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='in.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                            ...
                            <div class='row after-add-more'>
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'><h5><strong> Height <span class='text-danger'><span
                                                            class='required'>*</span></span> </strong></h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='heightft[]'
                                                   id='heightft${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='ft.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                                ...
                                <div class='col-lg-3 mb-1'>
                                    <div class='form-group'><h5 style='margin-top: 27px'></h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='heightin[]'
                                                   id='heightin${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='in.'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                                ...
                                <div class='col-lg-6 mb-1'>
                                    <div class='form-group'>
                                        <h5><strong> Weight <span class='text-danger'>
                                                        <span class='required'>*</span></span> </strong>
                                        </h5>
                                        <div class='controls position-relative has-icon-left'>
                                            <input required type='text' name='weight[]'
                                                   id='weight${Ophone_count}'
                                                   class='form-control this_save' value=''
                                                   placeholder='lbs'
                                                   data-validation-required-message='This field is required'
                                                   autocomplete='nope'>
                            ...
                            <div class='row'>
                                <div class='col-md-4 mb-1'>
                                    <h6>
                                        <strong> Is it in Auction? <span class='text-danger'><span
                                                        class='required'>*</span></span> </strong>
                                    </h6>
                                    <div class='controls position-relative has-icon-left'>
                                        <select autocomplete='nope' name='auction[]'
                                                class='form-control this_save'
                                                id='auction${Ophone_count}' required=''
                                                data-validation-required-message='This field is required'
                                                aria-invalid='false'>
                                            <option value=''>Select</option>
                                        ...
                                        <div class='form-control-position'><i class='la la-newspaper-o'></i></div>
                                        <div class='help-block'></div>
                                    </div>
                                </div>
                                <div class='col-md-4 mb-1'>
                                    <h6><strong> Vehicle Brakes <span class='text-danger'><span
                                                        class='required'>*</span></span> </strong>
                                    </h6>
                                    <div class='controls position-relative has-icon-left'>
                                        ...
                                        <div class='form-control-position'><i class='la la-car'></i></div>
                                        <div class='help-block'></div>
                                    </div>
                                </div>
                                <div class='col-md-4 mb-1'><h6><strong> Vehicle Rolls <span class='text-danger'><span
                                                        class='required'>*</span></span> </strong></h6>
                                    <div class='controls position-relative has-icon-left'>
                            ...
                            <div class='row mt-4 mb-2'>
                                <div class='col-md-4 mb-1'>
                                    <h6><strong> Vehicle Color <span class='text-danger'><span
                                                        class='required'>*</span></span> </strong>
                                    </h6>
                                    <div class='controls position-relative has-icon-left'>
                                        <input autocomplete='nope' type='text'
                                               name='vcolor[]' id='vcolor${Ophone_count}'
                                               class='form-control this_save' value=''
                                               placeholder='Enter Vehicle Color'
                                               required=''
                                               data-validation-required-message='This field is required'
                                               aria-invalid='false'>
                                        <div class='form-control-position'><i class='la la-eyedropper'></i></div>
                                        <div class='help-block'></div>
                                    </div>
                                </div>
