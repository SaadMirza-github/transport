...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header w-100" style="    border-bottom: 1px solid;">
                        <div class=" mb-0 w-100" style="text-align: center"><strong class="heading">Book Order
                                #{{ $data->id  }} </strong>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/order_payment" method="post" autocomplete="off" class="needs-validation">
                            ...
                            <input name="ip_address" value="{{$ip_address}}" type="hidden">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <table class="table customtable">
                                                            ...
                                                            <tr>
                                                                <td>Booking Price</td>
                                                                <td>
                                                                    <div class="bookPriceTab"> {{ $data->payment  }} </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>COD/COP</td>
                                                                <td>
                                                                    <div class="bookPriceTab"> {{ $data->cod_cop  }} </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>Listed Price</td>
                                                                <td>
                                                                    <div class="bookPriceTab"> {{ $data->listed_price  }} </div>
                                                                </td>
                                                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="card-body border">
                                        ...
                                        <div class="form-group">
                                            @php
                                                $vehicletype=explode('*^',$data->type);
                                            @endphp
                                            <label for="carrier"><strong>Vehicle Type</strong></label>
                                            <input autocomplete="nope" type="text" class="form-control"
                                                   disabled=""
                                                   value="@foreach($vehicletype as $veht) {{ $veht }} @endforeach">
                                        </div>

                                        <div class=form-group">
                                            @php
                                                $carriertype=explode('*^',$data->transport);
                                            @endphp
                                            <label for="carrier"><strong>Carrier Type</strong></label>
                                            <input autocomplete="nope" type="text" class="form-control"
                                                   disabled=""
                                                   value="@foreach($carriertype as $ctype) {{ $ctype }} @endforeach">
                                        </div>
                                        <div class=form-group">
                                            @php
                                                $condition=explode('*^',$data->condition);
                                            @endphp
                                            <label for="carrier"><strong>Condition</strong></label>
                                            <input autocomplete="nope" type="text" class="form-control"
                                                   disabled=""
                                                   value="@foreach($condition as $cond) @php if($cond==1) echo 'Running'; else echo 'Not Running';  @endphp @endforeach">
                                        </div>

                                        <div class=form-group">
                                            @php
                                                $isauction=explode('*^',$data->is_auction);
                                            @endphp
                                            <label for="carrier"><strong>In Auction</strong></label>
                                            <input autocomplete="nope" type="text" class="form-control"
                                                   disabled=""
                                                   value="@foreach($isauction as $auc) @php if($auc==1) echo 'Yes'; else echo 'No';  @endphp @endforeach">
                                        </div>

                                        @if($data->paynal_type==2)
                                            @php
                                                $lentghft=explode('*^',$data->length_ft);
                                            @endphp

                                            <div class=form-group">

                                                <label for="carrier"><strong>Length ft.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($lentghft as $leng) {{$leng}}  @endforeach">
                                            </div>


                                            @php
                                                $lentghin=explode('*^',$data->length_in);
                                            @endphp

                                            <div class=form-group">

                                                <label for="carrier"><strong>Length in.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($lentghin as $leng) {{$leng}}  @endforeach">
                                            </div>
                                            ...
                                            <div class=form-group">
                                                ...
                                                <label for="carrier"><strong>Width ft.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($widthft as $width) {{$width}}  @endforeach">
                                            </div>
                                            ...
                                            <div class=form-group">
                                                ...
                                                <label for="carrier"><strong>Width in.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($widthin as $width) {{$width}}  @endforeach">
                                            </div>

                                            @php
                                                $higthft=explode('*^',$data->height_ft);
                                            @endphp

                                            <div class=form-group">

                                                <label for="carrier"><strong>Height ft.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($higthft as $hig) {{$hig}}  @endforeach">
                                            </div>

                                            @php
                                                $higthin=explode('*^',$data->height_in);
                                            @endphp

                                            <div class=form-group">

                                                <label for="carrier"><strong>Height in.</strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled=""
                                                       value="@foreach($higthin as $hig) {{$hig}}  @endforeach">
                                            </div>
                                            ...
                                            <div class=form-group">
                                                ...
                                                <label for="carrier"><strong>Weight </strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled="" value="@foreach($weight as $w) {{$w}}  @endforeach">
                                            </div>
                                            ...
                                            <div class=form-group">
                                                ...
                                                <label for="carrier"><strong>Vehicle Color </strong></label>
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       disabled="" value="@foreach($color as $c) {{$c}}  @endforeach">
                                            </div>
                                        @endif
                                        @php  $vehiclearraycondition=explode('*^',$data->condition); @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls position-relative has-icon-left">
                                                <input autocomplete="nope" type="text"  name="vin" id="vin"
                                                       required class="form-control" value="{{$data->vin_no}}"
                                    ...
                                    <div class="card-body border">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="nope" type="text" class="form-control" id="dname"
                                                   name="dname" placeholder="Enter Contact Name"
                                                   value="{{ $data->dname }}">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input autocomplete="nope" type="text" class="form-control"
                                                       ...
                                                       placeholder="Enter Phone #" value="{{ $data->dphone  }}">
                                        ...
                                        <div class="form-group">
                                            <label for="state"><strong>City, State, Zip</strong><span
                                                        class="text-danger"> *</span></label>
                                            <input type="text" class="form-control"
                                                   value="{{ $data->destinationzsc }}" disabled="">
                            ...
                            <div class="row mt-5">
                                <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="card-body border">
                                        ...
                                        <div class="form-group">
                                            <textarea name="add_info" id="add_info" cols="30" rows="5"
                                                      class="form-control"> {{ $data->add_info }}</textarea>
                                        </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ol>
                                                        ...
                                                        <li class="text-justify">
                                                            ...
                                                            Autotransportgo Transport to charge an additional $100
                                                            reposting fee
                                                        ...
                                                        <li class="text-justify">
                                                            ...
                                                            and including trunk, therefore Autotransportgo Transport and
                                                            assigned
                                                        ...
                                                        <li class="text-justify">
                                                            ...
                                                            made in writing by fax or email. Autotransportgo Transport
                                                            has $99.00
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12 text-right">
                                    <button type="submit" class="btn btn-primary btn-lg" name="nextStep">Next Step
                                        &nbsp;
                                        > >
                                    </button>
                                </div>
                        ...
                        <div class="row skin skin-line">
                            ...
                            <div class="col-md-6 col-sm-12 mt-2 radio_style "  id="s1">
                                <fieldset class="sign1" id="first_sign">
                                    ...
                                    <label for="signature1"   id="signShw1" style="font-family: 'Brush Script MT', cursive;">${valueSign}</label>
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12 mt-2 radio_style" id="s2">
                                <fieldset class="sign2" id="second_sign">
                                    ...
                                    <label for="signature2" style="font-family: 'Shadows Into Light', cursive;" id="signShw2">${valueSign}</label>
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12 mt-2 radio_style" id="s3">
                                <fieldset class="sign3" id="third_sign">
                                    ...
                                    <label for="signature3"  style=" font-family: 'Rock Salt', cursive;"  id="signShw3">${valueSign}</label>
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12 mt-2 radio_style" id="s4">
                                <fieldset class="sign4" id="fourth_sign">
                                    ...
                                    <label for="signature4" style="font-family: 'Cedarville Cursive', cursive;"  id="signShw4">${valueSign}</label>
                                </fieldset>
                            </div>
