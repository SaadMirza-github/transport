        ...
        @foreach($data as $val)
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <span
                            style="color:black;font-weight:600;background: #ff8a7e;border-radius: 10px;padding:8px"> <?php echo $val->expected_date; ?></span>
                    <?php }else{?>
                    <span
                            style="color:black;font-weight:600;background: rgba(24,128,29,0.41);border-radius: 10px;padding:8px"><?php echo $val->expected_date; ?></span>
                    <?php }?>
