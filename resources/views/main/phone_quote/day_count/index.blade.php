                    ...
                    <div class="card-body">
                        <div class="col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                <select type="date" onchange="fetch_day2()" name="pstatus" id='pstatus'
                                        class="form-control select_pstatus">
