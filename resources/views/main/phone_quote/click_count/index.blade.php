...
@section('content')
    ...
    <input type="hidden" id="whatclick" name="whatclick" value=""/>
        ...
        <!--div-->
            <div class="card">
                <div class="card-header">
                    <h4 class="page-title mb-0">CLICK COUNT</h4>
                    <button type="button" onclick="Clickto(1);" class="btn btn-dark" style=" margin-left: auto; ">Phone
                        Clicks
                    </button>
                    <button type="button" onclick="Clickto(2);" class="btn btn-dark m-1">Sms Clicks</button>
                    <button type="button" onclick="Clickto(3);" class="btn btn-dark">Email Clicks</button>
...
@section('extraScript')
    ...
    <script>
        ...
        function Clickto(clickindex) {

            $('#whatclick').val(clickindex);
            $('#table_data').html('');
            $('#table_data').append(`<div class="lds-hourglass" id='ldss'></div>`);

            var typee = $('#whatclick').val();

            $.ajax({

                url: "/fetch_count?page=1" + "&typee=" + typee,
        ...
        $(document).ready(function () {
            ...
            function fetch_data3(page) {
                ...
                $.ajax({
                    ...
                    url: "/fetch_count?page=" + page + "&typee=" + typee,
                    success: function (data) {
                        $('#table_data').html('');
                        $('#table_data').html(data);
