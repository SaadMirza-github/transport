    ...
    <table id="example1" class="table table-bordered">
        ...
        @foreach($data as $val)
            ...
            <tr>
                ...
                <td class="{{$n_active}}" rowspan="1" style=" padding: 0px 55px !important; " >
                    {{$val->id}}
            ...
            <tr>
                <td class="{{$n_active}}"  rowspan="2" style=" padding: 0px 7px !important; ">
                ...
                <td class="{{$n_active}}">
                    <strong><i class="fa fa-location-arrow" style="color:green;" aria-hidden="true"></i>
                        <?php  $rest = ""; if (strlen($val->oaddress) > 20) {
                            $rest = substr($val->oaddress, 0, 20);
                        } else {
                            $rest = $val->oaddress;
                        }  ?><a class="btn  btn-sm"
                                data-toggle="tooltip" data-placement="top" style="padding: 0px"
                ...
                <td class="{{$n_active}}">
                    <strong><i class="fa fa-location-arrow" style="color:green;" aria-hidden="true"></i>
                        <?php  $rest = ""; if (strlen($val->daddress) > 20) {
                            $rest = substr($val->daddress, 0, 20);
                        } else {
                            $rest = $val->daddress;
                        }  ?><a class="btn  btn-sm"
                                data-toggle="tooltip" data-placement="top" style="padding: 0px"
                                title="<?php echo $val->daddress ?>"><?php echo $rest ?></a>
                    </strong>
                </td>
                <?php
                $condition1 = explode('*^', $val->condition);
                ?>
                <td class="{{$n_active}}">

                        <span class="text-center pd-2 bd-l">Trailer Type :
            ...
            <tr>
                ...
                <td class="{{$n_active}}">
                     <span class="text-center pd-2 bd-l">Condition :
                ...
                <?php $ophone = explode('*^', $val->ophone); ?>
                <td class="{{$n_active}}" style="padding-bottom: 7px !important;">
                    <span class="text-center pd-2 bd-l">COD/COP :${{$val->cod_cop}}</span><br>
