...
@section('content')
    ...
    <style>
        ...
        .btn-outline-light{
            border-color: rgb(240 240 242) !important;
        }
        .btn-outline-primary{
            border-color: rgb(112 94 200) !important;
        }
        .btn-outline-secondary{
            border-color: rgb(251 28 82) !important;
        }
        .btn-outline-success{
            border-color: rgb(56 203 137) !important;
        }
        .btn-outline-info{
            border-color: rgb(91 127 255) !important;
        }
        .btn-outline-warning{
            border-color: rgb(255 171 0) !important;
        }
        .btn-outline-danger{
            border-color: rgb(220 4 65) !important;
        }
        .click_show ul li a {
            padding: 10px 20px 11px 20px;
            display: block;
        ...
        .effect01 {
            color: #FFF;
            border: 2px solid #3486bd !important;
            box-shadow: 0px 0px !important;
                    ...
                    <div class="panel-body tabs-menu-body click_show">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="Admin">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                            ...
                                            <li>
                                                <a id="admin_new" onclick="get_data(0,'Admin_hidden','admin_new')"
                                                   ...
                                                   data-toggle="tab">
                                                    ...
                                                    <span class="badge side-badge">New </span>
                                                    <span class="badge badge-danger ">{{get_total_new(0,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li>
                                                <a id="admin_interested"
                                                   ...
                                                   data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Interested</span>
                                                    <span class="badge badge-danger ">{{get_total_new(1,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("4", $phoneaccess))
                                            <li >
                                                <a id="admin_not_interested"
                                                   ...
                                                   class="btn btn-outline-danger" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-thumbs-down mr-1"></i>--}}
                                                    <span class="badge  side-badge">Not Interested</span>
                                                    <span class="badge badge-danger ">{{get_total_new(4,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("5", $phoneaccess))
                                            <li>
                                                <a id="admin_not_answer"
                                                   ...
                                                   class="btn btn-outline-warning" data-toggle="tab">
                                                    {{--<i class="fa fa-phone-square mr-1"></i>--}}
                                                    <span class="badge  side-badge">Not Answer</span>
                                                    <span class="badge badge-danger ">{{get_total_new(5,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("6", $phoneaccess))
                                            <li>
                                                <a id="admin_time_quote"
                                                   ...
                                                   class="btn btn-outline-info" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-clock-o mr-1"></i>--}}
                                                    <span class="badge  side-badge">Time Quote</span>
                                                    <span class="badge badge-danger ">{{get_total_new(6,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("2", $phoneaccess))
                                            <li>
                                                <a id="admin_follow_more"
                                                   ...
                                                   class="btn btn-outline-warning" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-area-chart mr-1"></i>--}}
                                                    <span class="badge  side-badge">Follow More</span>
                                                    <span class="badge badge-danger ">{{get_total_new(2,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("18", $phoneaccess))
                                            <li >
                                                <a id="admin_p_issue" class="btn btn-outline-danger" data-toggle="tab"
                                                   onclick="get_data(18,'Admin_hidden','admin_p_issue')"
                                                   title="">
                                                    {{--<i class="fa fa-credit-card mr-1"></i>--}}
                                                    <span class="badge  side-badge">P.issue</span>
                                                    <span class="badge badge-danger ">{{get_total_new(18,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("7", $phoneaccess))
                                            <li >
                                                <a id="admin_p_missing"
                                                   ...
                                                   class="btn btn-outline-danger" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-credit-card mr-1"></i>--}}
                                                    <span class="badge  side-badge">P. Missing</span>
                                                    <span class="badge badge-danger ">{{get_total_new(7,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("19", $phoneaccess))
                                            <li>
                                                <a id="admin_active" class="btn btn-outline-primary" data-toggle="tab"
                                                   onclick="get_data(19,'Admin_hidden','admin_active')"
                                                   title="">
                                                    {{--<i class="fa fa-toggle-on mr-1"></i>--}}
                                                    <span class="badge  side-badge">Active</span>
                                                    <span class="badge badge-danger ">{{get_total_new(15,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("8", $phoneaccess))
                                            <li >
                                                <a id="admin_booked" onclick="get_data(8,'Admin_hidden','admin_booked')"
                                                   class="btn btn-outline-primary" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-toggle-on mr-1"></i>--}}
                                                    <span class="badge  side-badge">Booked</span>
                                                    <span class="badge badge-danger ">{{get_total_new(8,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li>
                                                <a id="admin_listed" onclick="get_data(9,'Admin_hidden','admin_listed')"
                                                   class="btn btn-outline-info" data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Listed</span>
                                                    <span class="badge badge-danger ">{{get_total_new(9,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li>
                                                <a id="admin_dispatch"
                                                   ...
                                                   data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Dispatch</span>
                                                    <span class="badge badge-danger ">{{get_total_new(10,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li>
                                                <a id="admin_picked_up"
                                                   ...
                                                   class="btn btn-outline-info" data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Picked Up</span>
                                                    <span class="badge badge-danger ">{{get_total_new(11,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li >
                                                <a id="admin_delivery"
                                                   ...
                                                   data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Delivery</span>
                                                    <span class="badge badge-danger ">{{get_total_new(12,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("13", $phoneaccess))
                                            <li >
                                                <a id="admin_completed"
                                                   ...
                                                   class="btn btn-outline-success" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-mail-forward  mr-1"></i>--}}
                                                    <span class="badge  side-badge">Completed</span>
                                                    <span class="badge badge-danger ">{{get_total_new(13,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        <li >
                                            <a id="search_btn_id"
                                               class="btn btn-outline-info search_btn" data-toggle="tab">
                                                {{--<i class="fa fa-search mr-1"></i>--}}
                                                <span class="badge side-badge">Global Search</span>
                                            </a>
                                        </li>
                                            ...
                                            <li >
                                                <a id="admin_no_payment_received"
                                                   ...
                                                   class="btn btn-outline-danger" data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">No Payment Received</span>
                                                </a>
                                            </li>
                                        @endif
                                            ...
                                            <li>
                                                <a id="admin_payment_update"
                                                   ...
                                                   class="btn btn-outline-info" data-toggle="tab" title="">
                                                    ...
                                                    <span class="badge  side-badge">Payment Update</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("35", $phoneaccess))
                                            <li>
                                                <a id="admin_payment_received"
                                                   ...
                                                   class="btn btn-outline-primary" data-toggle="tab" title="">
                                                    {{--<i class="fa fa-dollar"></i>--}}
                                                    <span class="badge  side-badge">Payment Received</span>
                                                </a>
                                            </li>
                                        @endif
                                        <li>
                                            <a id="admin_delete"
                                               ...
                                               class="btn btn-outline-danger" data-toggle="tab" title="">
                                                ...
                                                <span class="badge  side-badge">Deleted Quotes</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="tab-pane" id="OrderTaker">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                        ...
                                        <li  class="slide">
                                            <a class="btn btn-dark"  style=" border-radius: 100%; height: 46px; width: 50px; padding: 11px 15px; ">
                                                <i class="fa fa-plus" style="font-size: 23px"></i>
                                            </a>
                                        </li>
                                        <div id="fade-in" class="box">
                                            <li >
                                                <a href="/calling" target="_blank" class="btn btn-outline-info"
                                                   data-sm-link-text="Calling New" style=" border-radius: 100%; height: 46px; width: 50px; padding: 12px 17px; ">
                                                    <i class=" fa fa-phone mr-1"></i>
                                                    {{--<span class="badge side-badge" style=" color: black !important; ">calling</span>--}}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="/shipment" target="_blank" class="btn btn-outline-warning" style=" border-radius: 100%; height: 46px; width: 50px; padding: 12px 14px; "
                                                   title="">
                                                    <i class=" fa fa-ship mr-1"></i>
                                                    {{--<span class="badge  side-badge" style=" color: black !important; ">shipment</span>--}}
                                                </a>
                                            </li>
                                            <li>
                                                <a href="/heavy" target="_blank" class="btn btn-outline-primary " style=" border-radius: 100%; height: 46px; width: 50px; padding: 12px 14px; "
                                                   title="">
                                                    <i class=" fa fa-truck mr-1"></i>
                                                    {{--<span class="badge  side-badge" style=" color: black !important; ">heavy</span>--}}
                                                </a>
                                            </li>
                                        ...
                                        @if (in_array("18", $phoneaccess))
                                            <li>
                                                <a id="o_p_issue" class="btn btn-outline-danger" data-toggle="tab"
                                        ...
                                        @if (in_array("19", $phoneaccess))
                                            <li>
                                                <a id="o_active" class="btn btn-outline-info" data-toggle="tab"
                                                   onclick="get_data(19,'OrderTaker_hidden','o_active')"
                                                   title="">
                                                    {{--<i class="fa fa-toggle-on mr-1"></i>--}}
                                                    <span class="badge  side-badge">Active</span>
                                                    <span class="badge badge-danger ">{{get_total_new(19,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        @if (in_array("8", $phoneaccess))
                            ...
                            <div class="tab-pane" id="Dispatcher">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                        ...
                                        @if (in_array("19", $phoneaccess))
                                            <li >
                                                <a id="d_active" class="btn btn-outline-info"
                                                   data-toggle="tab"
                                        ...
                                        @if (in_array("8", $phoneaccess))
                                            <li >
                                                <a id="d_booked" class="btn btn-outline-primary" data-toggle="tab"
                                        ...
                                        @if (in_array("9", $phoneaccess))
                                            <li>
                                                <a id="d_listed" class="btn btn-outline-primary" data-toggle="tab"
                                        ...
                                        @if (in_array("10", $phoneaccess))
                                            <li>
                                                <a id="d_dispatch" class="btn btn-outline-info" data-toggle="tab"
                                        ...
                                        @if (in_array("11", $phoneaccess))
                                            <li>
                                                <a id="d_picked_up" class="btn btn-outline-info" data-toggle="tab"
                                        ...
                                        @if (in_array("12", $phoneaccess))
                                            <li>
                                                <a id="d_delivery" class="btn btn-outline-primary" data-toggle="tab"
                                        ...
                                        @if (in_array("13", $phoneaccess))
                                            <li>
                                                <a id="d_completed" class="btn btn-outline-success" data-toggle="tab"
                            ...
                            <div class="tab-pane" id="QA">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                        ...
                                        @if (in_array("5", $phoneaccess))
                                            <li>
                                                <a id="qa_not_answer"
                                                   ...
                                                   data-toggle="tab" class="btn btn-outline-warning "
                                                >
                                                    {{--<i class=" fa fa-phone mr-1"></i>--}}
                                                    <span class="badge  side-badge">Not Answer</span>
                                                    <span class="badge badge-danger ">{{get_total_new(5,0)}}</span>
                                        ...
                                        <li>
                                            <a class="btn btn-outline-primary " target="_blank" href="/qa_portal">
                                                {{--<i class="fa fa-star mr-1"></i>--}}
                                                <span class="badge  side-badge" style=" color: black !important; ">Rating</span>
                                            </a>
                                        </li>
                                ...
                                <div class="tabs-menu ">
                                    ...
                                    <!--
                                        ...
                                        <li data-toggle="tooltip" data-placement="bottom" title="shipment!">
                                            <a href="/shipment" target="_blank" class="btn btn-outline-secondary"
                                               title="">
                                                <i class=" fa fa-ship mr-1"></i>
                                                <span class="badge badge-danger side-badge">10</span>
                                            </a>
                                        ...
                                        <li data-toggle="tooltip" data-placement="bottom" title="heavy!">
                                            <a href="/heavy" target="_blank" class="btn btn-outline-primary "
                                               title="">
                                                <i class=" fa fa-truck mr-1"></i>
                                                <span class="badge badge-danger side-badge">10</span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a id="manager_pickup"
                                               ...
                                               class="btn btn-outline-info"
                                               style="width: 232px; color: black;" data-toggle="tab">
                                                <span class="badge  side-badge"> Pickup Pending</span>
                                                <span class="badge badge-danger ">{{get_total_new(20,0)}}</span>
                                            </a>
                                        </li>
                                        ...
                                        @if (in_array("20", $phoneaccess))
                                            <li class="">
                                                <a id="manager_deliver"
                                                   ...
                                                   class="btn btn-outline-danger"
                                                   style="width: 232px; color: black;" data-toggle="tab">
                                                    <span class="badge  side-badge">Deliver Pending</span>
                                                    <span class="badge badge-danger ">{{get_total_new(22,0)}}</span>
                                                </a>
                                            </li>
                                        @endif
                                        ...
                                        <li>
                                            <a href="#admin_new" id="requestedtrigger" onclick="get_requested_quotes()"
                                               ...
                                               data-toggle="tab">
                                                {{--<i class="fa fa-clipboard mr-1"></i>--}}
                                                <span class="badge  side-badge" style=" color: black !important; ">Requested Quotes</span>
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li>
                                            <a href="#tab11" data-toggle="tab">
                                                <span class="badge  side-badge">Res. Center</span>


                                            </a></li>
                                        <li>
                                            <a href="#tab12" data-toggle="tab">
                                                <span class="badge  side-badge">Res. Complete</span>
                            ...
                            <div class="tab-pane" id="tab6">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                        <li class=""><a href="#tab11" data-toggle="tab">
                                                <span class="badge  side-badge">Invalid</span>
                                                 </a></li>
                                        <li><a href="#tab12" data-toggle="tab">
                                                <span class="badge  side-badge">Cancel</span>
                                                </a></li>
                                        <li><a href="#tab13" data-toggle="tab">
                                                <span class="badge  side-badge">Delete</span>
                                                </a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tab8">
                                <div class="tabs-menu ">
                                    <ul class="nav panel-tabs">
                                        <li class=""><a href="#tab11" data-toggle="tab"> 2021 Data </a></li>
                                        <li><a href="#tab12" data-toggle="tab"> 2020 Data</a></li>
                                        <li><a href="#tab13" data-toggle="tab"><2019 Data</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab8">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane active">
                                    <div class="row" style="margin: 0px 0px 18px -35px;">
                                        <div class="col-md-12" style="display: inline-flex">
                                            <div class="tabs-menu "  style="display: inline-flex">
                                            {{--<textarea id="lock_text" style="display: none"></textarea>--}}
                                            <button type="button" class="btn_style count_user" id="phoneno2"
                                                    onclick="count_user(1)" style="width: 267px;">
                                                <i class="fa fa-dollar" style="color: white;"></i>
                                            </button>
                                            <button type="button" class="btn_style count_user" id="smscount"
                                                    onclick="count_user(2)">
                                                <i class="fa fa-dollar" style="color: white;"></i>
                                            </button>
                                            <button class="btn_style"> <a data-toggle="pill" href="#email_tab">Email</a></button>
                        ...
                        <div class="card">
                            <div class="card-body pd-20">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="ca_carrier_comments" id="ca_carrier_comments"
                                              style=" "></textarea>
                                    <br>
    ...
    <script>
        function popup_update(get) {
            ...
            <input type='radio' class='option-input radio radio_value' name='pstatus' value='5'>Not Respond &nbsp;                                                    <input type='radio' class='option-input radio radio_value' name='pstatus' value='4'>Not Interested &nbsp;&nbsp;&nbsp;
                ...
                <div class='col-md-3'>
                        <h6 style=" margin-left: 10%; padding-bottom:11px; ">Order Book By</h6>
                    <select  required id='book_source'  name='book_source'>
